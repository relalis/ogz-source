...
public:
	...
	virtual TSTR *snapname(int index)=0; // the snap뭩 name to be displayed in the UI
	virtual TSTR *tooltip(int index){return NULL;} // the snap뭩 name to be displayed in the UI
